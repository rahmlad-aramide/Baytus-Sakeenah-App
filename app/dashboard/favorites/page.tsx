...
const favoriteArticles = [
  {
    ...
    excerpt:
      "Trust is the foundation of any strong marriage. Here are practical ways to build and maintain trust...",
  ...
  },
  {
    ...
    excerpt:
      "Starting your married life with a solid financial foundation is crucial for long-term happiness...",
  ...
  },
  {
    ...
    excerpt:
      "Building positive relationships with in-laws requires patience, understanding, and Islamic wisdom...",
...
const favoriteStories = [
  {
    ...
    excerpt:
      "Marriage isn't always easy, but with patience and understanding, we learned to communicate better...",
  ...
  },
  {
    ...
    excerpt:
      "Many people question arranged marriages, but our journey shows how love can grow beautifully...",
    ...
    <div className="space-y-6 mt-17 lg:mt-0">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm lg:text-base text-gray-600 mt-1">
            Your saved articles, stories, questions, and mentors
          </p>
        </div>
        <div className="flex gap-2">
          <Button
            variant="outline"
            className="border-emerald-200 text-emerald-700 hover:bg-emerald-400 bg-transparent text-xs lg:text-base"
          >
            <Filter className="h-2 w-2 lg:h-4 lg:w-4 lg:mr-2" />
            Organize
          </Button>
          <Button
            variant="outline"
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        ...
        <div className="flex gap-2">
          <Select defaultValue="all">
            <SelectTrigger className="w-3/5 lg:w-[140px] text-xs lg:text-sm">
          ...
          <Select defaultValue="recent">
            <SelectTrigger className="w-2/5 lg:w-[120px] text-xs lg:text-sm">
      ...
      <Tabs defaultValue="articles" className="space-y-6">
        <TabsList className="grid w-full grid-cols-4">
          <TabsTrigger
            value="articles"
            className="flex items-center lg:gap-2 text-[9px] md:text-sm lg:text-base"
          >
            <BookOpen />
          ...
          <TabsTrigger
            ...
            className="flex items-center lg:gap-2 text-[9px] md:text-sm lg:text-base"
          >
            <MessageCircle className="h-1 w-1" />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="text-red-500 hover:text-red-600 text-[10px] lg:text-base"
                        >
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-xs lg:text-base text-gray-500 mb-4">
                  Start exploring our content hub to save articles you love
                </p>
                <Link href="/dashboard/content">
                  <Button className="text-[10px] lg:text-base bg-gradient-to-r from-emerald-700 to-green-600 hover:from-emerald-800 hover:to-green-700">
                    Browse Articles
                  </Button>
                </Link>
              </CardContent>
                  ...
                  <CardContent className="px-6">
                    <div className="flex items-start justify-between mb-1 lg:mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="text-sm lg:text-base text-gray-400 hover:text-red-500"
                        >
                    ...
                    <h3 className="text-sm lg:text-lg font-semibold mb-2">
                      <Link
                        ...
                        className="text-sm lg:text-base hover:text-emerald-700 transition-colors"
                      >
                        {story.title}
                      </Link>
                    </h3>
          ...
          {favoriteQAs.length > 0 ? (
              ...
              {favoriteQAs.map((qa) => (
                <Card key={qa.id} className="hover:shadow-md transition-shadow">
                  <CardContent className="px-6">
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {qa.tags.map((tag) => (
                        <Badge key={tag} variant="outline" className="text-[10px] lg:text-xs">
                          {tag}
                        </Badge>
                      ))}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1 text-[10px] lg:text-sm text-gray-500">
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-sm lg:text-lg font-medium text-gray-900 mb-2">
                  No favorite Q&A posts yet
                </h3>
                <p className="text-xs lg:text-base text-gray-500 mb-4">
                  Save helpful questions and answers from the community forum
                </p>
          ...
          {favoriteMentors.length > 0 ? (
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-xs lg:text-base text-gray-500 mb-4">
                  Save mentors you'd like to remember for future sessions
                </p>
        ...
        <CardContent className="p-6">
          <div className="grid gap-4 md:grid-cols-4 text-center">
            <div>
              ...
              <div className="text-xs lg:text-sm text-emerald-600">Articles Saved</div>
            </div>
            <div>
              <div className="text-xl lg:text-2xl font-bold text-emerald-700">
                {favoriteStories.length}
              </div>
              <div className="text-xs lg:text-sm text-emerald-600">Stories Saved</div>
            </div>
            <div>
              <div className="text-xl lg:text-2xl font-bold text-emerald-700">
                {favoriteQAs.length}
              </div>
              <div className="text-xs lg:text-sm text-emerald-600">Q&A Saved</div>
            </div>
            <div>
              <div className="text-xl lg:text-2xl font-bold text-emerald-700">
                {favoriteMentors.length}
              </div>
              <div className="text-xs lg:text-sm text-emerald-600">Mentors Saved</div>
            </div>
          </div>
        </CardContent>
      </Card>
